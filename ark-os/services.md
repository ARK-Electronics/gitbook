...
**flight-review** hosts a local [PX4 Flight Review](https://github.com/PX4/flight_review) server at [http://jetson.local/flight-review](http://jetson.local/flight-review) for the logs downloaded by logloader.
