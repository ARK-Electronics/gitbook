...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/OwmEn1N45AR4WjMQhHlu/products/flight-controller/ark-jetson-pab-carrier/usb-cameras-and-gps
---

# USB Cameras and GPS

USB cameras pose a unique challenge on drone platforms due to electromagnetic interference (EMI). USB 3.0 signaling is a well-documented source of GPS interference, emitting broadband EMI that overlaps with GPS frequencies across th L1, L2, and L5 bands. This interference can significantly elevate the noise floor, effectively burying the weak GPS signals and degrading or completely preventing GPS lock.
