...
metaLinks:
  alternates:
    - ../../ark-jetson-pab-carrier/setup/get-online.md
---
...
Open [http://jetson.local](http://jetson.local) (or [http://192.168.55.1](http://192.168.55.1) over USB-C) and join a network from the **Connections** page:
