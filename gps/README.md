...
{% content-ref url="ark-mosaic-x5-rtk-gps.md" %}
[ark-mosaic-x5-rtk-gps.md](ark-mosaic-x5-rtk-gps.md)
{% endcontent-ref %}
...
{% content-ref url="ark-teseo-gps.md" %}
[ark-teseo-gps.md](ark-teseo-gps.md)
{% endcontent-ref %}
