...
The Septentrio mosaic-G5 P3 module hosts a web interface for configuration, status, and diagnostics accessible via USB-C connector.

## Connect

1. Plug a USB-C cable from your computer to the USB-C port on the ARK G5 RTK GPS.
