...
| [CANNODE\_PUB\_IMU](https://docs.px4.io/main/en/advanced_config/parameter_reference.html#CANNODE_PUB_IMU) | Set to `1` on the ARK GPS via the [DroneCAN GUI Tool](../../knowledge-base/dronecan-gui-tool-guide.md) to publish the [`RawIMU`](../../knowledge-base/dronecan-messages.md#rawimu) messages on the CAN bus |
| [UAVCAN\_SUB\_IMU](https://docs.px4.io/main/en/advanced_config/parameter_reference.html#UAVCAN_SUB_IMU) | Set to `1` on the autopilot to subscribe to DroneCAN [`RawIMU`](../../knowledge-base/dronecan-messages.md#rawimu) messages. Requires `CANNODE_PUB_IMU` to also be set on the ARK GPS |
