...
GPS-derived heading from a moving-baseline solution. Published by GPS modules that support dual-antenna heading (e.g. the ARK G5H, and an ARK RTK GPS pair configured as base + rover).
...
| [ARK MOSAIC-X5 RTK GPS](../gps/ark-mosaic-x5-rtk-gps/) | [`Fix2`](#fix2), [`Auxiliary`](#gnss-auxiliary), [`RawIMU`](#rawimu) (optional) | — |
| [ARK G5 / G5H RTK GPS](../gps/ark-g5-rtk-gps/) | [`Fix2`](#fix2), [`Auxiliary`](#gnss-auxiliary), [`RawIMU`](#rawimu) (optional); [`RelPosHeading`](#relposheading) on the G5H when dual-antenna heading is enabled | — |
