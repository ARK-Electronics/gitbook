...
* **ESCs** ([ARK 4IN1 ESC](../electronic-speed-controller/ark-4in1-esc/README.md)) use STM32F0 MCUs running [ARK32](https://github.com/ARK-Electronics/ARK32) for motor control.
