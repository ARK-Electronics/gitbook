...
3. Set the [BATT2\_I2C\_BUS](https://ardupilot.org/copter/docs/parameters.html#batt2-i2c-bus-battery-monitor-i2c-bus-number) parameter to match the power connector the module is plugged into: `1` for Power 1, `2` for Power 2, `3` for Power 3
