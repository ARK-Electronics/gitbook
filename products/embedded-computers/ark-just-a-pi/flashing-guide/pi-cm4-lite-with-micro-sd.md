...
After flashing the SD card is complete, you will need to modify the **/boot/config.txt** file on the SD card before installing it into the Pi. See [**After Flashing, Before Installing**](../../../../flight-controller/ark-pi6x-flow/flashing-guide/after-flashing-before-installing.md)**.**
